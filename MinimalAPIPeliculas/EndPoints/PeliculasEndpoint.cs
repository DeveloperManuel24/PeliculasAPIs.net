...
namespace MinimalAPIPeliculas.EndPoints
{
    public static class PeliculasEndpoint
    {
                                                        ...
                                                        IMapper mapper)
        {
            ...
            if (crearPeliculaDTO.Poster is not null)
            {
                var url = await almacenadorArchivos.Editar(peliculaParaActualizar.Poster, "peliculas", crearPeliculaDTO.Poster);
        ...
        static async Task<Results<NotFound, NoContent, BadRequest<string>>> AsignarActores(
                                                                            int id,
