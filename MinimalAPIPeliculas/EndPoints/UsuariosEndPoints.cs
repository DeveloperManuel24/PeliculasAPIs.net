...
namespace MinimalAPIPeliculas.EndPoints
{
    public static class UsuariosEndPoints
    {
        ...
        static async Task<Results<Ok<RespuestaAutenticacionDTO>, BadRequest<string>>> Login(
                        CredencialesUsuarioDTO credencialesUsuarioDTO, [FromServices] UserManager<IdentityUser> userManager,
                        [FromServices] SignInManager<IdentityUser> signInManager, IConfiguration configuration)
        {
        ...
        //Metodo para renovar el token de manera automatica para que no se caiga la sesion
        ...
        //Metodo para construir Token a la hora de Autenticar al usuario
                                                                ...
                                                                UserManager<IdentityUser> userManager)
        {
            ...
            //Cargando el claim de admin a un usuario a la hora de crear el token
